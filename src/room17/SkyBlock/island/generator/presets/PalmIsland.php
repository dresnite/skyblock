...
class PalmIsland extends IslandGenerator {
    ...
    public function generateChunk(ChunkManager $world, int $chunkX, int $chunkZ): void {
        ...
        if($chunkX == 0 and $chunkZ == 0) {
            ...
            $world->setBlockAt(8, 39, 11, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(7, 39, 10, VanillaBlocks::SAND());
            $world->setBlockAt(7, 39, 9, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(10, 38, 11, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 11, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 11, VanillaBlocks::SAND());
            $world->setBlockAt(7, 38, 11, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(7, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 10, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(7, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(5, 38, 9, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(7, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(5, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 8, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(6, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(5, 38, 8, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 7, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 7, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 7, VanillaBlocks::WATER());
            $world->setBlockAt(8, 38, 7, VanillaBlocks::WATER());
            $world->setBlockAt(7, 38, 7, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 7, VanillaBlocks::SAND());
            $world->setBlockAt(5, 38, 7, VanillaBlocks::SAND());
            $world->setBlockAt(11, 38, 6, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 6, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 6, VanillaBlocks::WATER());
            $world->setBlockAt(8, 38, 6, VanillaBlocks::WATER());
            $world->setBlockAt(7, 38, 6, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 6, VanillaBlocks::SAND());
            $world->setBlockAt(5, 38, 6, VanillaBlocks::SAND());
            $world->setBlockAt(10, 38, 5, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 5, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 5, VanillaBlocks::WATER());
            $world->setBlockAt(7, 38, 5, VanillaBlocks::SAND());
            $world->setBlockAt(6, 38, 5, VanillaBlocks::SAND());
            $world->setBlockAt(9, 38, 4, VanillaBlocks::SAND());
            $world->setBlockAt(8, 38, 4, VanillaBlocks::SAND());
            $world->setBlockAt(7, 38, 4, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 11, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 11, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 11, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 10, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 10, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 10, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 10, VanillaBlocks::SAND());
            $world->setBlockAt(6, 37, 10, VanillaBlocks::SAND());
            $world->setBlockAt(11, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(6, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(5, 37, 8, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 9, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 9, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 9, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 9, VanillaBlocks::SAND());
            $world->setBlockAt(6, 37, 9, VanillaBlocks::SAND());
            $world->setBlockAt(11, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(6, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(5, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 7, VanillaBlocks::SAND());
            $world->setBlockAt(10, 37, 6, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 6, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 6, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 6, VanillaBlocks::SAND());
            $world->setBlockAt(6, 37, 6, VanillaBlocks::SAND());
            $world->setBlockAt(9, 37, 5, VanillaBlocks::SAND());
            $world->setBlockAt(8, 37, 5, VanillaBlocks::SAND());
            $world->setBlockAt(7, 37, 5, VanillaBlocks::SAND());
            $world->setBlockAt(8, 36, 11, VanillaBlocks::SAND());
            $world->setBlockAt(10, 36, 10, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(6, 36, 10, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(6, 36, 6, VanillaBlocks::SAND());
            $world->setBlockAt(9, 36, 5, VanillaBlocks::SAND());
            $world->setBlockAt(8, 36, 5, VanillaBlocks::SAND());
            ...
            $world->setBlockAt(5, 35, 8, VanillaBlocks::SAND());
