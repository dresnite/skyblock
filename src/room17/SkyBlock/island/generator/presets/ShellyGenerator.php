...
class ShellyGenerator extends IslandGenerator {
    ...
    public function generateChunk(ChunkManager $world, int $chunkX, int $chunkZ): void {
        ...
        if($chunkX == 0 && $chunkZ == 0) {
            ...
            $chunk->setFullBlock(10, 34, 10, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(9, 34, 10, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(9, 34, 9, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(8, 34, 10, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(8, 34, 9, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(8, 34, 8, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(7, 34, 9, VanillaBlocks::GRASS()->getTypeId());
            ...
            $chunk->setFullBlock(7, 34, 8, VanillaBlocks::GRASS()->getTypeId());
            $chunk->setFullBlock(7, 33, 8, VanillaBlocks::DIRT()->getTypeId());
            ...
            $chunk->setFullBlock(6, 35, 8, VanillaBlocks::CHEST()->getTypeId());
